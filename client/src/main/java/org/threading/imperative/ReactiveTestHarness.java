...
@Slf4j
public class ReactiveTestHarness {

  private final String experimentName;
  private final int numberOfTasks;

  private final Supplier<Mono<String>> supplier;
  ...
  private ReactiveTestHarness(String experimentName, int numberOfTasks, Supplier<Mono<String>> supplier) {
  ...
  private void run() {
    ...
    List<String> results = Flux.merge(requests).toStream().toList();
